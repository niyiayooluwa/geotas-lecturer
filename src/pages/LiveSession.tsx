...
export default function LiveSession() {
  ...
  return (
    <div className="min-h-screen bg-black flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      {/* Main Content */}
      {error ? (
        <div className="flex flex-col items-center justify-center w-[95vh] h-[95vh] text-center bg-neutral-900/50 rounded-3xl border border-red-900/50 p-8">
        ...
        <div className="flex flex-col items-center justify-center w-[95vh] h-[95vh] bg-neutral-900 rounded-3xl">
          <div className="animate-pulse flex flex-col items-center">
            <div className="w-64 h-64 bg-neutral-800 rounded-lg mb-8"></div>
            <p className="text-neutral-500 font-medium text-lg">Generating secure token...</p>
          </div>
        </div>
      ) : (
        <div className="relative w-[95vh] h-[95vh] max-w-full max-h-full flex items-center justify-center p-8 bg-black">
          <QRCode 
            value={token} 
            size={256}
      ...
      {token && !error && (
        <div className="absolute bottom-8 left-8 flex items-center gap-4 bg-neutral-900/60 backdrop-blur-xl px-5 py-3 rounded-full border border-neutral-800 shadow-2xl">
          ...
          <div className="flex flex-col">
            <span className="text-neutral-200 text-sm font-medium tracking-wide">Rotating Code</span>
